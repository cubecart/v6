{if $DISPLAY_3DS}
	<div id="3dsecure" style="width:450px; height:400px; margin-left: auto; margin-right: auto; overflow: visible; ">
	    <iframe width="450px" height="400px" style="border: 0; margin-left: auto; margin-right: auto; " scrolling="auto" src="{$STORE_URL}/modules/gateway/IridiumCorp/3DSecure.php"></iframe>
	</div>
{else}
	...
	<script type="text/javascript" >
	    $(document).ready(function() 
	    {
	    	...
	    	$('.cdtCardDetailsTransasction').hide();
	    	$('.crtCrossReferenceTransasction').show();
	    	
			{else}
			
	    	$('.crtCrossReferenceTransasction').hide();
	    	$('.cdtCardDetailsTransasction').show();
	    	
			{/if}	    	
			
	    	$('input[name=CurrentTransactionType]').change(function () {
	    		switch ($(this).val())
	    		{
	    			case 'cdt' :
	    				$(".crtCrossReferenceTransasction").hide();
