	...
	class ISOCountry {
        ...
        public function __construct($nISOCode, $szCountryShort2, $szCountryShort3, $szCountryName, $nListPriority) {
            if (!is_int($nISOCode) ||
                    ...
                    !is_string($szCountryShort2) ||
                    !is_string($szCountryShort3) ||
	...
	class ISOCountryList {
        ...
        public function getISOCountry($szCountry, &$icISOCountry) {
            ...
            while ($nCount < count($this->m_licISOCountries)) {
                ...
                if (($szCountry == $icISOCountry2->getCountryShort2())
                        || ($szCountry == $icISOCountry2->getCountryShort3())
                        || ($szCountry == $icISOCountry2->getISOCode())) {
		...
		public function getISOCurrency($vCurrency, &$icISOCurrency)
		{
	        ...
	        while (!$boFound &&
	              	$nCount < count($this->m_licISOCurrencies))
	     	{
                ...
                if (($vCurrency == $icISOCurrency2->getCurrencyShort())
                || ($vCurrency == $icISOCurrency2->getISOCode())) {
