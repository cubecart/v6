...
class Gateway {
	...
	public function fixedVariables() {
		...
		$cryptVars .= "&CallbackURL=".$GLOBALS['storeURL'].'/index.php?_g=rm&type=gateway&cmd=process&module=PaymentSense_Redirect&cart_order_id='.$this->_basket['cart_order_id'];
		...
		$cryptVars .= "&ServerResultURL=".$GLOBALS['storeURL'].'/index.php?_g=rm&type=gateway&cmd=call&module=PaymentSense_Redirect&cart_order_id='.$this->_basket['cart_order_id'];
		...
		$hidden	= 	array(
						...
						'CallbackURL' => $GLOBALS['storeURL'].'/index.php?_g=rm&type=gateway&cmd=process&module=PaymentSense_Redirect&cart_order_id='.$this->_basket['cart_order_id'],
						'OrderDescription' => "",
						...
						'ServerResultURL' => $GLOBALS['storeURL'].'/index.php?_g=rm&type=gateway&cmd=call&module=PaymentSense_Redirect&cart_order_id='.$this->_basket['cart_order_id'],
	...
	public function call() {
		...
		{	
			...
			try
			{
				...
				$transData['gateway'] 		= "PaymentSense_Redirect";
