    ...
    (function(a) {
                                ...
                                a.each(j, function(p, r) {
                                    ...
                                    switch (r.type) {
                                        ...
                                        case "file":
                                            ...
                                            var l = "0";
                                            if (typeof(file_default) != "number") {
                                                file_default = 0
                                            }
                                            if (file_default == r.id) {
                                                var n = "2"
                                            } else {
                                                var n = (typeof(file_list) == "object" && array_search(r.id, file_list)) ? 1 : 0
                                            }
        ...
        a("#content_body").on("click", "img.checkbox", function() {
            ...
            switch (a(e).val()) {
                ...
                default:
                    if (f) {
                        a(".fm-container input.toggle").val("0").change()
                    }
                    var d = "1";
                    break
            }
