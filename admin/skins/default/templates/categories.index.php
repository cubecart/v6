...
<form action="{$VAL_SELF}" method="post" id="cat_form" name="cat_form" enctype="multipart/form-data">
  ...
  <div id="cat_description" class="tab_content">
	...
	<div id="cat_images" class="tab_content">
		...
		{include file='templates/element.image_picker.php'
		   single=true
		   storage_key="cat_`$CATEGORY.cat_id`"
		   dropzone_url="?_g=filemanager&cat_id=`$CATEGORY.cat_id`"
  ...
  <h3>{$LANG.settings.title_seo}</h3>
    <fieldset>
	  ...
	  <div><label for="seo_meta_title">{$LANG.settings.seo_meta_title}</label><span><input type="text" name="cat[seo_meta_title]" id="seo_meta_title" class="textbox strlen" rel="seo_meta_title_strlen" value="{$CATEGORY.seo_meta_title}"> <span id="seo_meta_title_strlen">{if $CATEGORY.seo_meta_title}{strlen($CATEGORY.seo_meta_title)}{/if}</span></span></div>
  ...
  <div id="general" class="tab_content">
	<fieldset><legend>{$LANG.common.general}</legend>
	  ...
	  {foreach from=$LANGUAGES item=lang}<option value="{$lang.code}"{$lang.selected}{$lang.disabled}>{$lang.title}</option>{/foreach}
	  </select></span></div>
	</fieldset>
  </div>
  ...
  <fieldset>
  	  <legend>{$LANG.settings.title_seo_meta_data}</legend>
	  <div><label for="seo_meta_title">{$LANG.settings.seo_meta_title}</label><span><input type="text" name="translate[seo_meta_title]" id="seo_meta_title" class="textbox strlen" value="{$TRANS.seo_meta_title}" rel="seo_meta_title_strlen"></span> <span id="seo_meta_title_strlen">{if $TRANS.seo_meta_title}{strlen($TRANS.seo_meta_title)}{/if}</span></div>
	  ...
	  <div><label for="seo_meta_description">{$LANG.settings.seo_meta_description}</label><span><textarea name="translate[seo_meta_description]" id="seo_meta_description" class="textbox strlen" rel="seo_meta_description_strlen">{$TRANS.seo_meta_description}</textarea></span> <span id="seo_meta_description_strlen">{if $TRANS.seo_meta_description}{strlen($TRANS.seo_meta_description)}{/if}</span></div>
	</fieldset>
  </div>
