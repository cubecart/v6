...
<div id="stats_best_customers" class="tab_content">
    ...
    <table width="100%">
        ...
        <tr>
            ...
            <td><a href="?_g=customers&node=index&action=edit&customer_id={$customer.customer_id}">{$customer.last_name},
                    {$customer.first_name}</a></td>
...
<div id="stats_online" class="tab_content">
    ...
    <table width="100%">
        ...
        <tr>
            <td align="center"><img
                    src="{$SKIN_VARS.admin_folder}/skins/{$SKIN_VARS.skin_folder}/images/{$user.is_admin}.png"></td>
            <td>
                <strong>
