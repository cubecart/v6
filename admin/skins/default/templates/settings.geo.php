...
<form action="{$VAL_SELF}" method="post" enctype="multipart/form-data">
    <div id="countries" class="tab_content">
        ...
        <table>
            ...
            <tr>
                <td><input type="checkbox" name="multi_country[{$country.id}]" name="multi_country" value="1"
                           class="all-countries"></td>
                ...
                <td align="center"><input name="country[{$country.id}][eu]" id="{$country.id}_eu" type="hidden"
                                          class="toggle" value="{$country.eu}"></td>
                <td align="center"><input name="country[{$country.id}][status]" id="{$country.id}_status" type="hidden"
                                          class="toggle" value="{$country.status}"></td>
                <td align="center"><a href="{$country.delete}" class="delete"
    ...
    <div id="add_country" class="tab_content">
        ...
        <fieldset>
            <div><label for="country-name">{$LANG.country.country_name}</label><span><input type="text"
                                                                                            name="new_country[name]"
                                                                                            id="country-name"
                                                                                            class="textbox required"></span>
            </div>
            <div><label for="country-iso">{$LANG.country.country_iso_alpha2}</label><span><input type="text"
                                                                                                 name="new_country[iso]"
                                                                                                 id="country-iso"
                                                                                                 class="textbox"></span>
            </div>
            <div><label for="country-iso3">{$LANG.country.country_iso_alpha3}</label><span><input type="text"
                                                                                                  name="new_country[iso3]"
                                                                                                  id="country-iso3"
                                                                                                  class="textbox"></span>
            </div>
            <div><label for="country-num">{$LANG.country.country_iso_numeric}</label><span><input type="text"
                                                                                                  name="new_country[numcode]"
                                                                                                  id="country-num"
                                                                                                  class="textbox"></span>
            </div>
            <div><label for="country-eu">{$LANG.country.assign_to_eu}</label><span><input name="new_country[eu]"
                                                                                          id="country-eu" type="hidden"
                                                                                          class="toggle"
                                                                                          value="0"/></span></div>
        </fieldset>
    </div>
    ...
    <div id="zones" class="tab_content">
        ...
        <table>
            ...
            <tr>
                ...
                <td><a href="{$zone.delete}" class="delete" title="{$LANG.notification.confirm_delete}"><i
    ...
    <div id="add_zone" class="tab_content">
		...
		{foreach from=$SELECT_COUNTRY item=country}<option value="{$country.id}">{$country.name}</option>{/foreach}
            ...
            <div><label for="zone-name">{$LANG.country.zone_name}</label><span><input type="text" name="new_zone[name]"
                                                                                      id="zone-name"
                                                                                      class="textbox required"></span>
            </div>
            <div><label for="zone-abbrev">{$LANG.country.zone_abbrev}</label><span><input type="text"
                                                                                          name="new_zone[abbrev]"
                                                                                          id="zone-abbrev"
