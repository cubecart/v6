      ...
      <table width="100%">
         ...
         <tbody>
            ...
            <tr>
               ...
               <td><a href="{$order.link_edit}">{if $CONFIG.oid_mode=='i'}{$order.id}{else}{$order.cart_order_id}{/if}</a></td>
               <td align="center">
      ...
      <div id="order_summary" class="tab_content" style="width: 660px;">
         ...
         <div id="order_overview">
            ...
            <fieldset id="items">
               ...
               <div id="item">
                  <strong>{$product.quantity} x {$product.name}</strong> - {$product.product_code} ({$product.line_formatted})<span>{$product.price_total_formatted}</span>
