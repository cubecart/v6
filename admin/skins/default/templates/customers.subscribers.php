...
<form action="{$VAL_SELF}" method="post" enctype="multipart/form-data">
    <div id="general" class="tab_content">
        ...
        <table>
            ...
            <tr>
                <td><input type="checkbox" name="rem_subscriber[{$subscriber.subscriber_id}]" value="1"
                           class="subscribers"></td>
                <td>{$subscriber.email}</td>
                <td align="center"><a href="?_g=customers&node=subscribers&delete={$subscriber.subscriber_id}"
                                      class="delete" title="{$LANG.notification.confirm_delete}"><i class="fa fa-trash"
    ...
    <div id="import" class="tab_content">
        ...
        <fieldset>
            ...
            <div><label for="emails">{$LANG.newsletter.email_list}</label><br><textarea name="subscribers"
                                                                                        class="textbox"
                                                                                        placeholder="{$LANG.newsletter.email_list_placeholder}"></textarea>
            </div>
        </fieldset>
    </div>
