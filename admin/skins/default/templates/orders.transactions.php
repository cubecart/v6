...
<div id="logs" class="tab_content">
    ...
    <form action="{$VAL_SELF}" method="post">
        <div>
            <input type="text" name="search" class="textbox"> <input type="submit" value="{$LANG.common.search}"
                                                                     class="mini_button">
        </div>
    ...
    <table>
        ...
        <tr>
            <td><a href="{$transaction.link}" title="{$LANG.orders.title_transaction_view}">{$transaction.order_id}</a>
            </td>
