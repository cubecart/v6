...
<div id="disabled-zone-list" class="tab_content">
    ...
    <fieldset id="disabled-zones">
        <legend>{$LANG.module.title_regions_disabled}</legend>
        {foreach from=$DISABLED_COUNTRIES item=country}
        <div>
            <span class="actions"><a href="#" class="remove dynamic" title="{$LANG.messages.confirm_delete}"><i
    ...
    <fieldset>
        <legend>{$LANG.module.title_regions_add}</legend>
        <div class="inline-add">
		  ...
		  <a href="#" class="add" target="disabled-zones"><i class="fa fa-plus-circle"
