   ...
   <table width="70%">
      ...
      <tbody>
         ...
         <tr>
            ...
            <td width="10"><a href="?_g=products&action=edit&product_id={$warn.product_id}{if $warn.M_use_stock==1}#Options{/if}" class="edit"><i class="fa fa-pencil-square-o" title="{$LANG.common.edit}"></i></a></td>
         </tr>
         {/foreach}
      </tbody>
   </table>
