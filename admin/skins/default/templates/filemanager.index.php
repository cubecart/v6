	...
	<div id="filemanager" class="tab_content">
		...
		<div id="fm-wrapper" class="images" style="overflow:hidden;">
			...
			<div class="fm-item folder {$FM_SIZE}">
				<a href="{$folder.link}" class="thumbnail fm_folder fm_location item_link"><img src="{$SKIN_VARS.admin_folder}/skins/default/images/folder_large.png" /></a>
				<span class="actions">
