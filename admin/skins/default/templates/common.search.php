    ...
    <div id="sidebar_content">
        <div class="sidebar_content">
            <form action="?_g=customers" method="post">
                ...
                <input type="text" name="search[keywords]" placeholder="&#xF002; {$LANG.common.type_to_search}"
        ...
        <div class="sidebar_content">
            <form action="?_g=products" method="post">
                ...
                <input type="text" name="search[product]" placeholder="&#xF002; {$LANG.common.type_to_search}"
        ...
        <div class="sidebar_content">
            <form action="?_g=orders" method="post">
                ...
                <input type="text" name="search[order_number]" placeholder="&#xF002; {$LANG.common.type_to_search}"
                       id="search_order" class="textbox left">
                <input type="submit" value="{$LANG.common.go}" class="go_search">
                <input type="hidden" name="token" value="{$SESSION_TOKEN}">
            </form>
        </div>
        {if isset($SIDEBAR_CONTENT)} {foreach from=$SIDEBAR_CONTENT item=content}
