...
<form action="{$VAL_SELF}" method="post" enctype="multipart/form-data">
    <div id="general" class="tab_content">
        <fieldset>
            ...
            <div><label for="email_subject">{$LANG.email.news_subject}</label><span><input type="text"
                                                                                           name="newsletter[subject]"
                                                                                           id="email_subject"
                                                                                           class="required textbox"
                                                                                           value="{$NEWSLETTER.subject}"></span>
            </div>
            <div><label for="sender_name">{$LANG.email.news_sender_name}</label><span><input type="text"
                                                                                             name="newsletter[sender_name]"
                                                                                             id="sender_name"
                                                                                             class="textbox"
                                                                                             value="{$NEWSLETTER.sender_name}"> ({$LANG.email.empty_equals_default})</span>
            </div>
            <div><label for="sender_email">{$LANG.email.news_sender_email}</label><span><input type="text"
                                                                                               name="newsletter[sender_email]"
                                                                                               id="sender_email"
                                                                                               class="textbox"
                                                                                               value="{$NEWSLETTER.sender_email}"> ({$LANG.email.empty_equals_default})</span>
            </div>
            <div>
    ...
    <div id="email_html" class="tab_content">
        ...
        <textarea name="newsletter[content_html]" id="content_html"
                  class="textbox fck">{$NEWSLETTER.content_html}</textarea>
    </div>
    ...
    <div id="send_test" class="tab_content">
        ...
        <fieldset>
            <div><label for="email_test">{$LANG.email.test_email}</label><span><input type="text"
                                                                                      name="newsletter[test_email]"
                                                                                      id="email_test" class="textbox"
                                                                                      value=""> <input type="submit"
                                                                                                       value="{$LANG.email.save_send_test}"
                                                                                                       class="tiny"></span>
            </div>
        </fieldset>
    </div>
    ...
    <table width="100%">
        ...
        <tr>
            ...
            <td><span class="actions">
               <a href="{$newsletter.send}" class="confirm" title="{$LANG.email.confirm_send}"><i
                       class="fa fa-paper-plane" title="{$LANG.common.send}"></i></a>
               <a href="{$newsletter.edit}" class="edit" title="{$LANG.common.edit}"><i class="fa fa-pencil-square-o"
                                                                                        title="{$LANG.common.edit}"></i></a>
               <a href="{$newsletter.delete}" class="delete" title="{$LANG.notification.confirm_delete}"><i
    ...
    <div id="export_mailing_list" class="tab_content">
        ...
        <fieldset>
            ...
            <div>
                ...
                <span>
               <input type="text" name="maillist_format" id="format" class="textbox" value="{$EMAIL_ADDRESS}"
                      title="{literal}e.g. {$EMAIL_ADDRESS} <{$FULL_NAME_SHORT}>{/literal}">
...
<div class="tab_content" id="newsletter_send">
    <div id="progress_wrapper">
        ...
        <div id="progress_bar"><img src="{$SKIN_VARS.admin_folder}/skins/{$SKIN_VARS.skin_folder}/images/loading.gif"
                                    alt="" class="newsletter"></div>
    </div>
    <div id="progress_bar_percent"></div>
    <p><a href="?_g=customers&node=email" class="delete"
          title="{$LANG.email.confirm_cancel}">{$LANG.email.news_cancel}</a></p>
</div>
{/if}