   ...
   <body>
      ...
      <div id="header">
         ...
         <span class="user_info">
            <a href="?_g=settings&node=admins&action=edit&admin_id={$ADMIN_UID}" id="admin_id">{$ADMIN_USER}</a> <a href="?_g=logout&amp;token={$SESSION_TOKEN}" title="{$LANG.account.logout}" class="btn btn-signout"><i class="fa fa-sign-out"></i> {$LANG.account.logout}</a>
         </span>
      </div>
      <div id="wrapper">
         <div id="navigation">
