...
<form action="{$VAL_SELF}" method="post" enctype="multipart/form-data">
   ...
   <div id="general" class="tab_content">
      ...
      <fieldset>
         ...
         <div><label for="product_code">{$LANG.catalogue.product_code_auto}</label><span><input name="product_code_auto" id="product_code_auto" type="checkbox" {$PRODUCT.auto_code_checked}> <input name="product_code_old" id="product_code_old" type="hidden" value=""> </span></div>
