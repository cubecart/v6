...
<form action="{$VAL_SELF}" method="post" enctype="multipart/form-data" id="add_edit_product">
   ...
   <div id="general" class="tab_content">
      ...
      <fieldset>
         ...
         <div><label for="live_from">{$LANG.catalogue.live_from}</label><span><input name="live_from" id="live_from" class="textbox" type="text" value="{if $PRODUCT.live_from>0}{$PRODUCT.live_from|date_format:"d F Y H:i:s"}{/if}" placeholder="{$LANG.catalogue.live_from_eg}"></span></div>
      </fieldset>
      <fieldset>
   ...
   <div id="pricing" class="tab_content">
      ...
      <div id="group_0" class="field_select_target">
         ...
         <fieldset>
            ...
            <div><label for="maximum_quantity">{$LANG.catalogue.maximum_quantity}</label><span><input name="maximum_quantity" id="maximum_quantity" class="textbox number-right" type="text" value="{if $PRODUCT.maximum_quantity==0}{else}{$PRODUCT.maximum_quantity}{/if}">&nbsp;{$LANG.common.blank_to_disable}</span></div>
         </fieldset>
         <fieldset>
            <table>
               <thead>
         ...
         <table>
            ...
            <tbody id="options_added">
               ...
               <tr id="option_member_{$option.set_member_id}">
                  ...
                  <td style="text-align:center"><input type="hidden" id="matrix_include_member_{$option.set_member_id}" name="option_create[{$option.set_member_id}][matrix_include]" value="0" class="toggle"></td>
                  <td>{$option.display}</td>
                  <td>{$option.set_name}</td>
   ...
   <div id="image" class="tab_content">
      ...
      {include file='templates/element.image_picker.php'
         storage_key="prod_`$PRODUCT.product_id`"
         dropzone_url="?_g=filemanager&product_id=`$PRODUCT.product_id`"
         initial_json=$IMAGE_PICKER_JSON
         placeholder=$IMG_PICKER_PLACEHOLDER
         hint="{$LANG.catalogue.image_main} = position 1. Click an image to add. Drag to reorder."
   ...
   <div id="seo" class="tab_content">
      ...
      <fieldset>
         ...
         <div><label for="seo_meta_title">{$LANG.settings.seo_meta_title}</label><span><input name="seo_meta_title" id="seo_meta_title" class="textbox strlen" rel="seo_meta_title_strlen" type="text" value="{$PRODUCT.seo_meta_title}"></span> <span id="seo_meta_title_strlen">{if $PRODUCT.seo_meta_title}{strlen($PRODUCT.seo_meta_title)}{/if}</span></div>
         ...
         <div><label for="seo_meta_description">{$LANG.settings.seo_meta_description}</label><span><textarea name="seo_meta_description" id="seo_meta_description" class="textbox strlen" rel="seo_meta_description_strlen">{$PRODUCT.seo_meta_description}</textarea></span> <span id="seo_meta_description_strlen">{if $PRODUCT.seo_meta_description}{strlen($PRODUCT.seo_meta_description)}{/if}</span></div>
      </fieldset>
   ...
   <div id="seo" class="tab_content">
      ...
      <fieldset>
         <legend>{$LANG.settings.title_seo_meta_data}</legend>
         <div><label for="seo_meta_title">{$LANG.settings.seo_meta_title}</label><span><input name="translate[seo_meta_title]" id="seo_meta_title" class="textbox strlen" rel="seo_meta_title_strlen" type="text" value="{$TRANS.seo_meta_title}"></span> <span id="seo_meta_title_strlen">{if $TRANS.seo_meta_title}{strlen($TRANS.seo_meta_title)}{/if}</span></div>
         <div><label for="seo_meta_description">{$LANG.settings.seo_meta_description}</label><span><textarea name="translate[seo_meta_description]" id="prod_seo_description" class="textbox strlen" rel="prod_seo_description_strlen">{$TRANS.seo_meta_description}</textarea></span> <span id="prod_seo_description_strlen">{if $TRANS.seo_meta_description}{strlen($TRANS.seo_meta_description)}{/if}</span></div>
      </fieldset>
   </div>
   {include file='templates/element.hook_form_content.php'}
   <div class="form_control">
