...
if (isset($_GET['action'])) {
	...
	foreach ($GLOBALS['hooks']->load('admin.documents.tabs') as $hook) include $hook;
	...
	$GLOBALS['main']->addTabControl($lang['orders']['invoice_editor'], '_blank','?_g=documents&node=invoice');
	## List all documents
