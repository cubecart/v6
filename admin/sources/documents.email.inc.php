...
$email_types = array(
	'account.password_recovery' => array(
		...
		'macros' => array(
			'{$DATA.first_name|capitalize}' => $lang['email']['macro_first_name'],
			'{$DATA.last_name|capitalize}'  => $lang['email']['macro_last_name'],
	...
	'admin.order_received' => array(
		...
		'macros' => array(
			'{$SHIPPING.first_name|capitalize}'  => $lang['email']['macro_first_name_d'],
			'{$SHIPPING.last_name|capitalize}'  => $lang['email']['macro_last_name_d'],
			'{$SHIPPING.company_name}'  => $lang['email']['macro_company_name_d'],
			'{$SHIPPING.line1|capitalize}'   => $lang['email']['macro_line1_d'],
			'{$SHIPPING.line2|capitalize}'   => $lang['email']['macro_line2_d'],
			...
			'{$BILLING.first_name|capitalize}'  => $lang['email']['macro_first_name'],
			'{$BILLING.last_name|capitalize}'  => $lang['email']['macro_first_name'],
			'{$BILLING.company_name}'  => $lang['email']['macro_company_name'],
			'{$BILLING.line1|capitalize}'    => $lang['email']['macro_line1'],
			'{$BILLING.line2|capitalize}'    => $lang['email']['macro_line2'],
	...
	'cart.gift_certificate' => array(
		...
		'macros' => array (
			...
			'{$DATA.first_name|capitalize}' => $lang['email']['macro_sender_name_first'],
			'{$DATA.last_name|capitalize}'  => $lang['email']['macro_sender_name_last'],
	...
	'cart.order_complete' => array(
		...
		'macros' => array (
			...
			'{$DATA.first_name|capitalize}' => $lang['email']['macro_first_name'], // back compatibility help
			'{$DATA.last_name|capitalize}' => $lang['email']['macro_first_name'], // back compatibility help
			'{$product.name}'  => $lang['email']['macro_product_name'],
			'{$product.product_code}' => $lang['email']['macro_product_code'],
			'{$product.quantity}' => $lang['email']['macro_product_quantity'],
			'{$product.price}'  => $lang['email']['macro_product_price'],
