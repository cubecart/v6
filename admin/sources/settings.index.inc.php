...
$select_options = array(
	...
	'recaptcha' => array(0 => $lang['common']['off']." (".$lang['common']['not_recommended'].")", 1 => "reCAPTCHA v1 (Unavailable from March 31, 2018)", 2 => "reCAPTCHA v2 *", 3 => 'Invisible reCAPTCHA * ('.$lang['common']['recommended'].')'),
