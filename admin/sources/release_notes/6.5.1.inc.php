...
$elastic = <<<END
    <p><img src="./{$GLOBALS['config']->get('config', 'adminFolder')}/skins/default/images/logo.elasticsearch.png" alt="Elasticsearch" /></p>
	...
	<video width="750" loop="true" autoplay="autoplay" controls muted>
		<source src="./{$GLOBALS['config']->get('config', 'adminFolder')}/skins/default/media/movie.elasticsearch.mp4" type="video/mp4">
	</video>
END;
