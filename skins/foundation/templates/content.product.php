      ...
      <div class="row">
         <div class="small-7 columns">            
            ...
            <ul class="clearing-thumbs small-block-grid-5 marg-top" data-clearing>
               ...
               <li><a href="{$image.source}"><img src="{$image.gallery}" data-image-swap="{$image.medium}" data-caption="{if empty($image.description)}{$PRODUCT.name}{else}{$image.description}{/if}" class="th image-gallery" alt="{$LANG.catalogue.click_enlarge}"></a></li>
               {/foreach}
            </ul>
            {/if}
         </div>
