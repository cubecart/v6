...
<div class="row">
   <div class="small-12 columns"><img src="{$category.image}" alt="{if isset($category.image_tags.alt)}{$category.image_tags.alt}{else}{$category.cat_name}{/if}"{if isset($category.image_tags.title)} title="{$category.image_tags.title}"{/if} class="marg-bottom"></div>
</div>
{/if}
         ...
         <form action="{$VAL_SELF}" method="post" class="panel add_to_basket">
               ...
               <div class="small-3 columns">
                  ...
                  <div class="row collapse">
                     <div class="small-4 columns">
                        <input type="number" name="quantity" aria-label="{$LANG.common.quantity}" value="{$product.minimum_quantity|default:'1'}" maxlength="4" class="quantity text-center">
                     </div>
            ...
            <div class="product_grid_view hide">
               ...
               *}
               ...
               <div class="row collapse marg-top">
                  <div class="small-3 columns">
                     <input type="number" name="quantity" aria-label="{$LANG.common.quantity}" value="{$product.minimum_quantity|default:'1'}" min="{$product.minimum_quantity}" maxlength="4" class="quantity text-center" disabled>
                  </div>
