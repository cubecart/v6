         ...
         <form action="{$VAL_SELF}" method="post" class="panel add_to_basket">
            ...
            <div class="product_grid_view hide">
               ...
               *}
               ...
               <div class="row collapse marg-top">
                  <div class="small-3 columns">
                     <input type="number" name="quantity" aria-label="{$LANG.common.quantity}" value="{$product.minimum_quantity|default:'1'}" min="{$product.minimum_quantity}" maxlength="3" class="quantity text-center" disabled>
                  </div>
