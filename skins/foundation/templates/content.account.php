...
<ul class="no-bullet small-block-grid-1 medium-block-grid-3 large-block-grid-3">
   ...
   <li><a href="{$list_item.href}" title="{$list_item.title}" class="button secondary expand nomarg">{if !empty($list_item.fa)}<i class="fa {$list_item.fa}"></i> {/if}{$list_item.title}</a></li>
   {/foreach}
