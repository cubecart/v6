            ...
            *}
            ...
            <div class="row collapse marg-top">
               <div class="small-3 columns">
                  <input type="number" name="quantity" aria-label="{$LANG.common.quantity}" maxlength="4" value="{$product.minimum_quantity|default:'1'}" min="{$product.minimum_quantity}" class="quantity required text-center">
               </div>
