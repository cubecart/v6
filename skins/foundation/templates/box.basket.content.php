...
<div class="box-basket-content" id="box-basket-content">
   ...
   <div class="pad-side basket-detail">
      ...
      <div><a href="{$STORE_URL}/index.php?_a=checkout" class="button expand marg-top">{if $CONFIG.ssl}<i class="fa fa-lock"></i> {$LANG.basket.basket_secure_checkout}{else}<i class="fa fa-lock"></i>{$LANG.basket.basket_checkout}{/if}</a></div>
      {if !$IS_USER}
