            ...
            <div class="row">
                ...
                <div class="small-4 columns">
                    <a href="javascript:Recaptcha.reload()">
                        <svg class="icon" title="{$LANG.form.recaptcha_try_diff_img}">
                            <use xlink:href="#icon-refresh"></use>
                        </svg>
                    </a>
                    <span class="recaptcha_only_if_image"><a href="javascript:Recaptcha.switch_type('audio')"><svg
                                class="icon" title="{$LANG.form.recaptcha_get_audio}"><use
                                    xlink:href="#icon-volume-up"></use></svg></a></span>
                    <span class="recaptcha_only_if_audio"><a href="javascript:Recaptcha.switch_type('image')"><svg
                                class="icon" title="{$LANG.form.recaptcha_get_img}"><use
                                    xlink:href="#icon-picture-o"></use></svg></a></span>
                    <span><a href="javascript:Recaptcha.showhelp()"><svg class="icon" title="{$LANG.common.help}"><use
                                    xlink:href="#icon-info-circle"></use></svg></a></span>
                </div>
            </div>
