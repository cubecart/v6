...
<div class="row">
    <div class="large-6 columns">
        <form action="{$VAL_SELF}" id="login_form" method="post">
            <p class="show-for-small-only">{$LANG.account.want_to_signup} <a href="{$STORE_URL}/register.html">{$LANG.account.register_here}</a>
            </p>
            ...
            <div class="row">
                <div class="small-12 columns">
                    ...
                    <input type="text" name="username" id="login-username"
                           placeholder="{$LANG.user.email_address} {$LANG.form.required}" value="{$USERNAME}" required>
                </div>
            </div>
            <div class="row">
                <div class="small-12 columns">
                    <label for="login-password" class="show-for-medium-up">{$LANG.account.password}</label><input
                        type="password" autocomplete="off" name="password" id="login-password"
                        placeholder="{$LANG.account.password} {$LANG.form.required}" required>
                </div>
            </div>
            <div class="row">
                <div class="small-12 columns">
            ...
            <div class="row">
                <div class="small-12 columns"><input type="checkbox" name="remember" id="login-remember" value="1" {if
                                                     $REMEMBER}checked{/if}><label for="login-remember">{$LANG.account.remember_me}</label>
                </div>
            </div>
            <div class="row">
                <div class="small-12 columns">
