...
<form action="{$VAL_SELF}" method="post" id="{$FORM_ID}">
    <div class="row">
        <div class="small-12 large-8 columns">
            ...
            <input type="text" name="{$SUBSCRIBE_MODE}" class="required" id="newsletter_email"
    ...
    <div class="row">
        <div class="small-12 large-8 columns"><input name="submit" class="button" type="submit"
                                                     value="{$LANG.form.submit}"></div>
    </div>
</form>
{/if}
