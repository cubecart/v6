...
class Newsletter
{
    ...
    {
        /*
        $this->_mailer->addCustomHeader("List-Unsubscribe","<".$GLOBALS['storeURL']."/index.php?_a=unsubscribe&unsubscribe=".urlencode($email).">, <mailto: ".$this->_mailer->From."?subject=Unsubscribe>");
