...
CREATE TABLE IF NOT EXISTS `CubeCart_admin_users` (
	...
	`verify` VARCHAR(64) DEFAULT NULL,
	...
	`extensions_dismissed` TEXT NULL,
	`news_dismissed_link` CHAR(32) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `CubeCart_manufacturers` (
	...
	`eu_line1` varchar(200) NOT NULL,
	`eu_line2` varchar(200) NOT NULL,
	`eu_town` varchar(100) NOT NULL,
	`eu_state` varchar(100) NOT NULL,
	`eu_postcode` varchar(15) NOT NULL,
	`eu_country` mediumint(3) NOT NULL,
	`eu_email` varchar(200) NOT NULL,
	`eu_phone` varchar(20) NOT NULL,
	`eu_contact_url` varchar(200) NOT NULL,
  	PRIMARY KEY  (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci; #EOQ 
