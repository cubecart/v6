  ...
  {if isset($MODE_INSTALL)}
	...
	<div class="install-grid">
	  ...
	  <div class="install-grid-col">
		...
		<fieldset>
		  <div><label for="form-dbhost" class="help" title="{$LANG.setup.help_dbhostname}">{$LANG.setup.db_host}</label><span><input type="text" name="global[dbhost]" id="form-dbhost"{if isset($FORM.global.dbhost)} value="{$FORM.global.dbhost}"{/if} class="textbox" placeholder="localhost" /></span></div>
