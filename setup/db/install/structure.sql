...
CREATE TABLE IF NOT EXISTS `CubeCart_inventory` (
  ...
  `tax_type` int(10) unsigned DEFAULT NOT NULL COMMENT 'Tax Type',
  ...
  `seo_meta_title` text NOT NULL COMMENT 'SEO Meta Title',
  `seo_meta_description` text NOT NULL COMMENT 'SEO Meta Description',
  `seo_meta_keywords` text NOT NULL COMMENT 'SEO Meta Keywords',
