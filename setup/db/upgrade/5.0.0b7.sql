ALTER TABLE `CubeCart_seo_urls` CHANGE `type` `type` VARCHAR( 45 ) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NOT NULL; #EOQ

ALTER TABLE `CubeCart_option_assign` ADD `option_negative` TINYINT( 1 ) UNSIGNED NOT NULL DEFAULT '0'; #EOQ

ALTER TABLE `CubeCart_seo_urls` CHANGE `type` `type` VARCHAR( 25 ) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NOT NULL; #EOQ
