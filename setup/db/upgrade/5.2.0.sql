...
ALTER TABLE `CubeCart_inventory` CHANGE `product_code` `product_code` VARCHAR(60) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT 'Product Code'; #EOQ 
ALTER TABLE `CubeCart_inventory` CHANGE `quantity` `quantity` INT(11) NOT NULL DEFAULT '1' COMMENT 'Quantity'; #EOQ 
ALTER TABLE `CubeCart_inventory` CHANGE `description` `description` TEXT CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT 'Description'; #EOQ 
...
ALTER TABLE `CubeCart_inventory` CHANGE `name` `name` VARCHAR(250) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT 'Product Name'; #EOQ 
...
ALTER TABLE `CubeCart_inventory` CHANGE `digital_path` `digital_path` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT 'Digital Path'; #EOQ 
...
ALTER TABLE `CubeCart_inventory` CHANGE `seo_meta_title` `seo_meta_title` TEXT CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'SEO Meta Title'; #EOQ 
ALTER TABLE `CubeCart_inventory` CHANGE `seo_meta_description` `seo_meta_description` TEXT CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'SEO Meta Description'; #EOQ 
ALTER TABLE `CubeCart_inventory` CHANGE `seo_meta_keywords` `seo_meta_keywords` TEXT CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'SEO Meta Keywords'; #EOQ 
ALTER TABLE `CubeCart_inventory` CHANGE `upc` `upc` VARCHAR(20) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT 'UPC Code'; #EOQ 
ALTER TABLE `CubeCart_inventory` CHANGE `ean` `ean` VARCHAR(20) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT 'EAN Code'; #EOQ 
ALTER TABLE `CubeCart_inventory` CHANGE `jan` `jan` VARCHAR(20) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT 'JAN Code'; #EOQ 
ALTER TABLE `CubeCart_inventory` CHANGE `isbn` `isbn` VARCHAR(20) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT 'ISBN Code'; #EOQ 
...
ALTER TABLE `CubeCart_inventory` CHANGE `condition` `condition` VARCHAR(25) CHARACTER SET utf8 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT 'Condition'; #EOQ
