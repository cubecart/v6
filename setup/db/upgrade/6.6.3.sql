...
ALTER TABLE `CubeCart_order_inventory` DROP INDEX `cart_order_id`; #EOQ
...
ALTER TABLE `CubeCart_admin_users` ADD COLUMN `news_dismissed_link` CHAR(32) DEFAULT NULL; #EOQ
